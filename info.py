...
PICS = (environ.get('PICS', 'https://graph.org/file/cb1d46fec963f4b01788d.jpg')).split() #SAMPLE PIC
...
CODE = (environ.get('CODE', 'https://envs.sh/bV-.jpg'))
...
BOT_USERNAME = environ.get("BOT_USERNAME", "Adv3_Obot")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5821871362').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001818253894').split()] #Channel id for auto indexing ( make sure bot is admin )
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5821871362').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1002456671995') #Channel / Group Id for force sub ( make sure bot is admin )
...
SHORTLINK_API = environ.get('SHORTLINK_API', '54d55bd43a0a4973707a0a695741217245e7eb34')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/xeonflixmovies')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Xeonflix')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/DowPCMOffcL/2')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ: Xeon bot')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001870015374')) #Log channel id ( make sure bot is admin )
